...
* [#13501](http://dev.ckeditor.com/ticket/13501): Added the [`config.fileTools_defaultfile_name`](http://docs.ckeditor.com/#!/api/CKEDITOR.config-cfg-fileTools_defaultfile_name) option to allow setting a default file name for paste uploads.
